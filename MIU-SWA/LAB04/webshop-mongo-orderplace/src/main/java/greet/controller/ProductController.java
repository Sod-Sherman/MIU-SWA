...
public class ProductController {
	...
	public ResponseEntity<Product> setStock(@PathVariable("prodId") Integer prodId,
			@PathVariable("quantity") int quantity, @PathVariable("locationcode") String locationcode) {
